...
| D-006 | 待定 | **比赛时间线与 MVP 排期** | 🔄 讨论中 | 阻塞 Sprint 0 校准 |
| D-007 | 待定 | **模型供应商与 API 预算**（1 主 + 1 备） | 🔄 讨论中 | 阻塞 T-008 |
| D-008 | 待定 | **团队实际人力与分工** | 🔄 讨论中 | 决定 P0 最小集范围 |
| D-009 | 待定 | **用户验证与开发并行 or 串行** | 🔄 讨论中 | 决定 T-005 排期 |
